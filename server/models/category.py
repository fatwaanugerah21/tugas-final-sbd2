...
class Category(object):
    ...
    def create(self, category):
        ...
        self.validator.validate(category, self.fields, self.create_required_fields, self.create_optional_fields)
    ...
    def update(self, id, category):
        self.validator.validate(category, self.fields, self.update_required_fields, self.update_optional_fields)
